...
function fetchSDKs(){
    ...
    PIP_PACKAGES=("beautifulsoup4" "qiskit" "pyquil" "projectq" "strawberryfields" "pennylane" "qmlt" "pennylane_pq" "pennylane-sf" "qutip" "qinfer" "dwave-ocean-sdk" "dwave-sdk" "cirq" "openfermion" "openfermioncirq")
