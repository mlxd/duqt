...
function fetchSDKs(){
    ...
    PIP_PACKAGES=("beautifulsoup4" "qiskit" "pyquil" "projectq" "strawberryfields" "pennylane" "qmlt" "qutip" "qinfer" "dwave-ocean-sdk" "dwave-sdk" "cirq" "openfermion" "openfermioncirq")
